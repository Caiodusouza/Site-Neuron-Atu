...
export default function Exchange() {
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 border-2 border-red-200 bg-white dark:bg-gray-800">
              <div className="text-center space-y-8">
                ...
                <div className="relative w-110 h-80 mx-auto ">
                  <Image
                    src="/AviaoGlobo.png"
  ...
  {[
    ...
    <div
      key={index}
      className="group p-4 bg-blue-500 dark:bg-blue-600 rounded-full flex flex-col items-center justify-center text-white cursor-pointer transform transition-all hover:scale-105 hover:bg-blue-600 dark:hover:bg-blue-700 w-1/4 h-32"
    >
      <item.icon className="w-8 h-8 mb-2" />
          <span className="text-xs text-center">{item.text}</span>
                ...
                <Button className="bg-red-500 hover:bg-red-600 text-white w-32 h-16 flex items-center justify-center mx-auto">
  Acesse já
</Button>
      ...
      <section className="py-16 bg-blue-50 dark:bg-blue-900">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative h-[400px] top-16">
              <Image
                src="/JuninIA.png"
                alt="AI Assistant"
                fill
